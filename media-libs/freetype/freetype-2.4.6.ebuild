...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-add-subpixel-hinting-infinality-20110604-1.patch
	epatch "${FILESDIR}"/${PN}-enable-subpixel-hinting-infinality-20100909-1.patch
	epatch "${FILESDIR}"/${PN}-entire-infinality-patchset-20110604-1.patch
