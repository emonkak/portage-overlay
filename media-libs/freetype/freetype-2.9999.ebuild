...
EGIT_REPO_URI="git://git.sv.gnu.org/freetype/freetype2.git"
EGIT_BOOTSTRAP="autogen.sh"

inherit git-2 autotools-multilib flag-o-matic multilib

MY_PV="2.4.11"

DESCRIPTION="A high-quality and portable font engine"
HOMEPAGE="http://www.freetype.org/"
SRC_URI="utils?	( mirror://sourceforge/freetype/ft2demos-${MY_PV}.tar.bz2 )
	doc?	( mirror://sourceforge/freetype/${PN}-${MY_PV}.tar.bz2 )"
