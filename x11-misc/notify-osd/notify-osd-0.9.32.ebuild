...
SRC_URI="http://launchpad.net/${PN}/oneiric/0.9.32/+download/${P}.tar.gz"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-fix-configure-gtk.patch"
...
src_install() {
	...
	use savedconfig && save_config src/{bubble,defaults}.c
}
