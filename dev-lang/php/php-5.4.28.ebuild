...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/php/php-5.4.28.ebuild,v 1.1 2014/05/03 13:37:29 olemarkus Exp $
...
src_prepare() {
	...
	if [[ ${CHOST} == *-darwin* ]] ; then
		...
		# fix libiconv link error
		sed -e 's/iconv_open/lib&/' -e 's/iconv_close/lib&/' \
			-i ext/iconv/iconv.c || die
	fi
}
